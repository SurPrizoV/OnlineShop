function header(element) {
  ...
  headerCart.addEventListener("click", (event) => {
    event.preventDefault();
    window.application.screens["cartScreen"] = cartScreen;
    window.application.renderScreen("cartScreen");
  });
...
function cartBlock(container) {
  let cartBlockArray = [];
  const cartTop = document.createElement("div");
  cartTop.classList.add("top_cart", "center");
  cartBlockArray.push(cartTop);
  header(cartTop);
  ...
  cartBlockArray.push(cart);
  const cartContent = document.createElement("div");
  cartContent.classList.add("cart_content");
  cart.appendChild(cartContent);
  const cartNameBox = document.createElement("div");
  cartNameBox.classList.add("cart_name_box");
  cartContent.appendChild(cartNameBox);
  const item = document.createElement("p");
  item.textContent = "Товар";
  cartNameBox.appendChild(item);
  const amount = document.createElement("p");
  amount.textContent = "К-во";
  cartNameBox.appendChild(amount);
  const cartItem = document.createElement("div");
  cartItem.classList.add("cart_item");
  cartContent.appendChild(cartItem);
  const cartLeft = document.createElement("div");
  cartLeft.classList.add("cart_left");
  cartItem.appendChild(cartLeft);
  const cartTableImg = document.createElement("img");
  cartTableImg.setAttribute("src", "./src/img/cart/cart_menu.jpg");
  cartLeft.appendChild(cartTableImg);
  const cartInfo = document.createElement("div");
  cartInfo.classList.add("cart_info");
  cartLeft.appendChild(cartInfo);
  const menuLink = document.createElement("a");
  menuLink.setAttribute("href", "#");
  menuLink.classList.add("cart_product_name");
  cartInfo.appendChild(menuLink);
  const menuName = document.createElement("p");
  menuName.classList.add("cart_text", "item");
  menuName.textContent = "Стол MENU";
  menuLink.appendChild(menuName);
  const cartDescription = document.createElement("p");
  cartDescription.classList.add("cart_description");
  cartDescription.textContent =
    "Для того чтобы трапезничать было приятно, необходим правильный обеденный стол.";
  cartInfo.appendChild(cartDescription);
  const cartPrice = document.createElement("p");
  cartPrice.classList.add("cart_price");
  cartPrice.textContent = "34 000 руб.";
  cartInfo.appendChild(cartPrice);
  const cartLinkBox = document.createElement("div");
  cartLinkBox.classList.add("cart_link_box");
  cartInfo.appendChild(cartLinkBox);
  const favorites = document.createElement("a");
  favorites.setAttribute("href", "#");
  favorites.classList.add("cart_link_box1");
  favorites.textContent = "Избранные";
  cartLinkBox.appendChild(favorites);
  const clear = document.createElement("a");
  clear.setAttribute("href", "#");
  clear.classList.add("cart_link_box2");
  clear.textContent = "Удалить";
  cartLinkBox.appendChild(clear);
  const cartSelect = document.createElement("div");
  cartSelect.classList.add("cart_select");
  cartItem.appendChild(cartSelect);
  const cartInput = document.createElement("input");
  cartInput.setAttribute("type", "number");
  cartInput.setAttribute("value", "1");
  cartInput.setAttribute("min", "1");
  cartInput.classList.add("cart_input");
  cartSelect.appendChild(cartInput);
  const cartNastanItem = document.createElement("div");
  cartNastanItem.classList.add("cart_item");
  cartContent.appendChild(cartNastanItem);
  const cartNastanLeft = document.createElement("div");
  cartNastanLeft.classList.add("cart_left");
  cartNastanItem.appendChild(cartNastanLeft);
  const cartNastanImg = document.createElement("img");
  cartNastanImg.setAttribute("src", "./src/img/cart/cart_nastan.jpg");
  cartNastanImg.classList.add("cart_mobile_img");
  cartNastanLeft.appendChild(cartNastanImg);
  const cartNastanInfo = document.createElement("div");
  cartNastanInfo.classList.add("cart_info");
  cartNastanLeft.appendChild(cartNastanInfo);
  const menuNastanLink = document.createElement("a");
  menuNastanLink.setAttribute("href", "#");
  menuNastanLink.classList.add("cart_product_name");
  cartNastanInfo.appendChild(menuNastanLink);
  const menuNastanName = document.createElement("p");
  menuNastanName.classList.add("cart_text", "item");
  menuNastanName.textContent = "Диван NASTAN";
  menuNastanLink.appendChild(menuNastanName);
  const cartNastanDescription = document.createElement("p");
  cartNastanDescription.classList.add("cart_description");
  cartNastanDescription.textContent =
    "Модель отличается простотой линий и форм, отсутствием броского декора.";
  cartNastanInfo.appendChild(cartNastanDescription);
  const cartNastanPrice = document.createElement("p");
  cartNastanPrice.classList.add("cart_price");
  cartNastanPrice.textContent = "80 000 руб.";
  cartNastanInfo.appendChild(cartNastanPrice);
  const cartNastanLinkBox = document.createElement("div");
  cartNastanLinkBox.classList.add("cart_link_box");
  cartNastanInfo.appendChild(cartNastanLinkBox);
  const nastanFavorites = document.createElement("a");
  nastanFavorites.setAttribute("href", "#");
  nastanFavorites.classList.add("cart_link_box1");
  nastanFavorites.textContent = "Избранные";
  cartNastanLinkBox.appendChild(nastanFavorites);
  const nastanClear = document.createElement("a");
  nastanClear.setAttribute("href", "#");
  nastanClear.classList.add("cart_link_box2");
  nastanClear.textContent = "Удалить";
  cartNastanLinkBox.appendChild(nastanClear);
  const cartNastanSelect = document.createElement("div");
  cartNastanSelect.classList.add("cart_select");
  cartNastanItem.appendChild(cartNastanSelect);
  const cartNastanInput = document.createElement("input");
  cartNastanInput.setAttribute("type", "number");
  cartNastanInput.setAttribute("value", "1");
  cartNastanInput.setAttribute("min", "1");
  cartNastanInput.classList.add("cart_input");
  cartNastanSelect.appendChild(cartNastanInput);
  const cartButtons = document.createElement("div");
  cartButtons.classList.add("cart_button_left");
  cartContent.appendChild(cartButtons);
  const clearCartButton = document.createElement("button");
  clearCartButton.classList.add("cart_button_left_clear");
  ...
  continueShoppingButton.classList.add("cart_button_left_favorite");
  continueShoppingButton.textContent = "Продолжить покупки";
  const cartForm = document.createElement("div");
  cartButtons.appendChild(continueShoppingButton);
  cartForm.classList.add("cart_form");
  cart.appendChild(cartForm);
  const cartOrder = document.createElement("p");
  cartOrder.classList.add("cart_order");
  cartOrder.textContent = "Оформление заказа";
  cartForm.appendChild(cartOrder);
  const cartDetails = document.createElement("form");
  cartDetails.setAttribute("action", "#");
  cartDetails.classList.add("cart_details");
  cartForm.appendChild(cartDetails);
  const formName = document.createElement("input");
  formName.setAttribute("type", "text");
  formName.setAttribute("placeholder", "Имя Фамилия");
  formName.classList.add("cart_data");
  cartDetails.appendChild(formName);
  const formTel = document.createElement("input");
  formTel.setAttribute("type", "tel");
  formTel.setAttribute("placeholder", "+ 7 904 000 80 80");
  formTel.classList.add("cart_data");
  cartDetails.appendChild(formTel);
  const formAdress = document.createElement("input");
  formAdress.setAttribute("type", "text");
  formAdress.setAttribute("placeholder", "Адрес доставки");
  formAdress.classList.add("cart_data");
  cartDetails.appendChild(formAdress);
  const cartFinal = document.createElement("p");
  cartFinal.classList.add("cart_final");
  cartFinal.textContent = "Итого: 128 000 руб.";
  cartDetails.appendChild(cartFinal);
  const cartCheckOut = document.createElement("button");
  cartCheckOut.setAttribute("type", "submit");
  cartCheckOut.classList.add("cart_checkout", "cart_button");
  cartCheckOut.textContent = "Оформить заказ";
  cartDetails.appendChild(cartCheckOut);
  const cartSpecialOrder = document.createElement("p");
  cartSpecialOrder.classList.add("product__box__title", "center");
  cartSpecialOrder.textContent = "Специальные предложения";
  cartBlockArray.push(cartSpecialOrder);
  const cartProductBox = document.createElement("div");
  cartProductBox.classList.add("product_content", "center");
  cartBlockArray.push(cartProductBox);
  tatran(cartProductBox);
  vilora(cartProductBox);
  menu(cartProductBox);
  const catalogLink = document.createElement("a");
  catalogLink.classList.add("catalog_link");
  catalogLink.addEventListener("click", (event) => {
  ...
  catalogLink.textContent = "Перейти в каталог";
  cartProductBox.appendChild(catalogLink);
  cartBlockArray.forEach((element) => {
    container.appendChild(element);
  });
  footer(container);
}
